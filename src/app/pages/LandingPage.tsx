...
import { Search, CheckCircle, Star, Users, Shield, Sparkles, Brain, Zap } from 'lucide-react';
            ...
            <Card className="overflow-hidden rounded-2xl border-2 border-purple-200 shadow-xl">
              <CardContent className="p-8 sm:p-12">
                <div className="grid gap-8 md:grid-cols-2 md:items-center">
                  <div>
                    <div className="mb-4 inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-purple-600 to-blue-600 px-4 py-2">
                    ...
                    <p className="mb-6 text-lg text-gray-600">
                      Experience our cutting-edge AI-powered matching system that intelligently analyzes 
                      your requirements and finds the perfect entertainment professionals with precision 
                      and accuracy.
                    </p>
                    <ul className="mb-8 space-y-3">
                      <li className="flex items-center gap-3">
                        ...
                        <span className="text-gray-700">AI-driven skill & expertise matching</span>
                      </li>
                      <li className="flex items-center gap-3">
                        <div className="flex h-8 w-8 items-center justify-center rounded-full bg-blue-100">
                          <Zap className="h-5 w-5 text-blue-600" />
                        </div>
                        <span className="text-gray-700">Instant intelligent recommendations</span>
                      </li>
                      <li className="flex items-center gap-3">
                        <div className="flex h-8 w-8 items-center justify-center rounded-full bg-purple-100">
                          <Sparkles className="h-5 w-5 text-purple-600" />
                        </div>
                        <span className="text-gray-700">Smart scoring with top 3 perfect matches</span>
                      </li>
                    </ul>
                    <Link to="/matching">
                      <Button className="h-12 rounded-full bg-gradient-to-r from-purple-600 to-blue-600 px-8 hover:from-purple-700 hover:to-blue-700">
                  ...
                  <div className="relative">
                    <div className="rounded-xl bg-white p-6 shadow-xl ring-2 ring-purple-100">
                      ...
                      <div className="mb-4 h-3 overflow-hidden rounded-full bg-gray-200">
                        <div className="h-full w-[95%] rounded-full bg-gradient-to-r from-purple-600 via-blue-600 to-purple-600 animate-pulse"></div>
                      </div>
